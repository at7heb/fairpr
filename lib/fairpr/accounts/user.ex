defmodule Fairpr.Accounts.User do
  use Ash.Resource,
    otp_app: :fairpr,
  ...
  authentication do
    add_ons do
      ...
      confirmation :confirm_new_user do
        ...
        sender Fairpr.Accounts.User.Senders.SendNewUserConfirmationEmail
      end
    end

    tokens do
      enabled? true
      token_resource Fairpr.Accounts.Token
      signing_secret Fairpr.Secrets
    ...
    strategies do
      magic_link do
        ...
        sender Fairpr.Accounts.User.Senders.SendMagicLinkEmail
      end
      ...
      password :password do
        ...
        resettable do
          sender Fairpr.Accounts.User.Senders.SendPasswordResetEmail
